...
/**
 * Inclui um anexo de um Documento.
 *
 ...
 * @pw_element string $cArquivo Conteúdo do arquivo a ser anexado, compactado (zip) e convertido   em base 64.
 * @pw_element string $cMd5 MD5 do arquivo enviado na tag 'cArquivo'.
 * @pw_complex docIncluirAnexoRequest
 */
class DocIncluirAnexoRequest{
	/**
	...
	/**
	 * Conteúdo do arquivo a ser anexado, compactado (zip) e convertido   em base 64.
	 *
	 * @var string
	 */
	public string $cArquivo;
	/**
	 * MD5 do arquivo enviado na tag 'cArquivo'.
	 *
	 * @var string
	 */
	public string $cMd5;
