 ...
 * @pw_element string $cLinkDownload URL para download do anexo solicitado.
 * @pw_element string $dDtExpiracao Data de expiração da url disponibilizada.<BR>No formato dd/mm/aaaa.
 ...
 * @pw_complex docObterAnexoResponse
 */
class DocObterAnexoResponse{
	/**
	...
	/**
	 * URL para download do anexo solicitado.
	 *
	 * @var string
	 */
	public string $cLinkDownload;
	/**
	 * Data de expiração da url disponibilizada.<BR>No formato dd/mm/aaaa.
	 *
	 * @var string
	 */
	public string $dDtExpiracao;
	/**
