...
/**
 * Alteração de item da estrutura do produto.
 *
 ...
 * @pw_element itemMalhaAlterarArray $itemMalhaAlterar Item da estrutura do produto.
 * @pw_complex malhaAlterarRequest
 */
class MalhaAlterarRequest{
	/**
	 ...
	 *
	 * @var ItemMalhaAlterar[]
	 */
	public array $itemMalhaAlterar;
}
