 ...
 * @pw_element itemMalhaIncluirArray $itemMalhaIncluir Item da estrutura do produto.
 * @pw_complex malhaIncluirRequest
 */
class MalhaIncluirRequest{
	/**
	 ...
	 *
	 * @var ItemMalhaIncluir[]
	 */
	public array $itemMalhaIncluir;
}
