 ...
 * @pw_element string $filtrar_apenas_ativo Filtrar apenas contas correntes ativas
 * @pw_complex fin_conta_corrente_listar_request
 */
class Fin_conta_corrente_listar_request{
	/**
	...
	/**
	 * Filtrar apenas contas correntes ativas
	 *
	 * @var string
	 */
