...
/**
 * Resposta da solicitação de consulta de uma tarefa.
 *
 ...
 * @pw_element tarefa $tarefa Informações da tarefa.
 * @pw_complex ConsultarTarefaResponse
 */
class ConsultarTarefaResponse{
	/**
