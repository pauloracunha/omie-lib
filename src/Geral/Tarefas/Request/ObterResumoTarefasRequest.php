...
/**
 * Solicitação para obter o resumo das tarefas.
 *
 * @pw_element string $cApenasResumo Exibir apenas os registros pelo status S/N.
...
class ObterResumoTarefasRequest{
	/**
	 * Exibir apenas os registros pelo status S/N.
	 *
	 * @var string
	 */
