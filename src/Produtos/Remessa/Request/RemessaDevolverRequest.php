...
/**
 * Solicitação de devolução de uma remessa.
 *
 * @pw_element integer $nCodRem Código da Remessa no Omie
 * @pw_element itensArray $itens Informações dos itens que serão devolvidos.<BR><BR>Caso essa tag não seja preenchida será realizado a devolução integral de todos os itens da remessa.<BR><BR>Preenchimento opcional.
 * @pw_complex remessaDevolverRequest
 */
class RemessaDevolverRequest{
	/**
	...
	public int $nCodRem;
	/**
	 * Informações dos itens que serão devolvidos.<BR><BR>Caso essa tag não seja preenchida será realizado a devolução integral de todos os itens da remessa.<BR><BR>Preenchimento opcional.
	 *
	 * @var Itens[]
	 */
	public array $itens;
