...
namespace OmieLib\Produtos\Icmsorigem\Request;
...
/**
 * Solicitação da listagem da Origem da Mercadoria do ICMS.
 *
 ...
 * @pw_complex origMercListarRequest
 */
class OrigMercListarRequest{
	/**
