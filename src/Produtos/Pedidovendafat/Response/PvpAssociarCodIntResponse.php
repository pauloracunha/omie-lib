...
/**
 * Resposta da solicitação de alteração do código de integração do Pedido de Venda de Produto.
 *
 ...
 * @pw_complex pvpAssociarCodIntResponse
 */
class PvpAssociarCodIntResponse{
	/**
