...
/**
 * Resultado da solicitação de Listagem de cupons fiscais.
 *
 ...
 * @pw_element cuponsArray $cupons Lista de Cupons Fiscais.
 * @pw_complex cfcListarResponse
 */
class CfcListarResponse{
	/**
