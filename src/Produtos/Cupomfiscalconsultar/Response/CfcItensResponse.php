...
/**
 * Resultado da solicitação de Listagem de itens de cupom fiscal.
 *
 ...
 * @pw_element itensArray $itens Dados dos Itens do Cupom Fiscal.
 * @pw_complex cfcItensResponse
 */
class CfcItensResponse{
	/**
