...
namespace OmieLib\Produtos\Sat\Request;
 ...
 * @pw_element string $chNFe Chave de Acesso do CF-e-SAT.<BR><BR>Preenchimento obrigatório.
 ...
 * @pw_complex ImportarSatRequest
 */
class ImportarSatRequest{
	/**
