 ...
 * Itens da Fatura.
 *
 * @pw_element integer $nSeq Sequencia do Item da Fatura.<BR><BR>Preenchimento obrigatório.
 * @pw_element string $cChaveCte Chave de acesso do CT-e
 * @pw_element decimal $nValorCte Valor do CT-e.
 * @pw_complex itensFatura
 */
class ItensFatura{
	/**
	 * Sequencia do Item da Fatura.<BR><BR>Preenchimento obrigatório.
	 *
	 * @var integer
	 */
	public int $nSeq;
