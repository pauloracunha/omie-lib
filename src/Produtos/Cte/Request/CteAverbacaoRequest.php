...
/**
 * Solicitação de Averbação do CT-e.
 *
 ...
 * @pw_element string $cXmlCteAverb Xml da Averbação do CT-e.<BR><BR>Preechimento obrigatório.<BR><BR>Antes de enviar, converta os seus seguintes caracteres:<BR><BR>&amp; para &amp;amp; <BR>> para &amp;gt;<BR>< para &amp;lt;<BR>" para &amp;quot;<BR>' para &amp;apos;<BR>| para &amp;#124;<BR><BR>Após essa conversão aplique o MD5 para enviar no campo "cMd5CteAverbacao".<BR><BR>Observação: Para requisições SOAP usar CDATA como demonstra o exemplo abaixo:<BR>&lt;![CDATA[Conteúdo do campo convertido]]&gt;
 * @pw_element string $cMd5CteAverb MD5 do arquivo XML importado.<BR><BR>Preenchimento obrigatório.<BR><BR>Aplique o MD5 sobre o XML antes de realizar o consumo.<BR>
 * @pw_complex cteAverbacaoRequest
 */
class CteAverbacaoRequest{
	/**
