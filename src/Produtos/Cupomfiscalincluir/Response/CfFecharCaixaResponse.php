...
/**
 * Resposta da rotina de fechamento do caixa.
 *
 * @pw_element integer $nIdProc Número de identificação do processamento da solicitação.
 ...
 * @pw_element listaProcessadosArray $listaProcessados Lista de cupons processados.
 * @pw_complex cfFecharCaixaResponse
 */
class CfFecharCaixaResponse{
	/**
	 * Número de identificação do processamento da solicitação.
	 *
	 * @var integer
	 */
	public int $nIdProc;
	 ...
	 *
	 * @var ListaProcessados[]
	 */
	public array $listaProcessados;
}
