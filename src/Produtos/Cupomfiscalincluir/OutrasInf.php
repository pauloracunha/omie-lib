 ...
 *
 * @pw_element string $nMesa Número / identificação da mesa.
 * @pw_element integer $nPessoas Número/quantidade de pessoas atendidas.
...
class OutrasInf{
	...
	public string $nMesa;
	/**
	 * Número/quantidade de pessoas atendidas.
	 *
	 * @var integer
	 */
	public int $nPessoas;
