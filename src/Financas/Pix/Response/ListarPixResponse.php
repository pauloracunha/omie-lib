...
/**
 * Resposta da solicitação de listagem de detalhes do PIX.
 *
 ...
 * @pw_element ListaPixArray $ListaPix Lista de detalhes do PIX.
 * @pw_complex ListarPixResponse
 */
class ListarPixResponse{
	/**
	...
	/**
	 * Lista de detalhes do PIX.
	 *
	 * @var ListaPix[]
	 */
	public array $ListaPix;
}
