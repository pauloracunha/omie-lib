...
namespace OmieLib\Estoque\Comprador\Request;

use OmieLib\Common\OmieFail;
use OmieLib\Estoque\Comprador\Cadastros;
use OmieLib\Estoque\Comprador\CompradoresJsonClient;
use OmieLib\Estoque\Comprador\Response\CompradorListarResponse;

/**
 * Solicitação da listagem de compradores.
 *
 ...
 * @pw_complex CompradorListarRequest
 */
class CompradorListarRequest{
	/**
