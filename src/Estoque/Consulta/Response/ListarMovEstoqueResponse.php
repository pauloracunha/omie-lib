...
/**
 * Resposta da solicitação de listagem da movimentação do estoque.
 *
 ...
 * @pw_element movProdutoListarArray $movProdutoListar Movimentação do produto.
 * @pw_complex ListarMovEstoqueResponse
 */
class ListarMovEstoqueResponse{
	/**
	 ...
	 *
	 * @var MovProdutoListar[]
	 */
	public array $movProdutoListar;
}
