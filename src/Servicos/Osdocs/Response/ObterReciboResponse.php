...
/**
 * Resposta da solicitação de Informações do recibo
 *
 * @pw_element string $cNumOs Número da Ordem de Serviço.
 * @pw_element string $cNumRecibo Número do recibo
 * @pw_element string $cPdfRecibo Link para obter o PDF do recibo
 ...
 * @pw_complex ObterReciboResponse
 */
