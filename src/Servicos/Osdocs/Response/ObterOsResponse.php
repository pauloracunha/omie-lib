...
/**
 * Informações da Ordem de Serviço faturada.
 *
 * @pw_element string $cNumOs Número da Ordem de Serviço.
 * @pw_element string $cPdfOs Link para obter o PDF da Ordem de Serviço.
 ...
 * @pw_complex ObterOsResponse
 */
class ObterOsResponse{
	/**
	...
	/**
	 * Link para obter o PDF da Ordem de Serviço.
	 *
	 * @var string
	 */
	public string $cPdfOs;
	/**
