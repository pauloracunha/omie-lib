...
/**
 * Informações de um RPS faturado.
 *
 * @pw_element string $cNumOs Número da Ordem de Serviço.
 * @pw_element string $cNumRPS Número do RPS.
 * @pw_element string $cSerieRPS Série do RPS.
 * @pw_element string $cPdfRPS Link para obter o PDF do RPS.<BR>
 ...
 * @pw_complex ObterRPSResponse
 */
class ObterRPSResponse{
	/**
	...
	/**
	 * Link para obter o PDF do RPS.<BR>
	 *
	 * @var string
	 */
	public string $cPdfRPS;
	/**
