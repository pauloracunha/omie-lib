...
/**
 * Solicitação da Exclusão de itens do Contrato de Serviço
 *
 * @pw_element contratoChave $contratoChave Chave de Pesquisa do Contrato de Serviço.
 * @pw_element ItensExclusaoArray $ItensExclusao Itens a serem excluídos do contrato.
 * @pw_complex csExcluirItemRequest
 */
class CsExcluirItemRequest{
	/**
