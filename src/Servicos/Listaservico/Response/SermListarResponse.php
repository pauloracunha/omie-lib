...
namespace OmieLib\Servicos\Listaservico\Response;
...
/**
 * Resposta da solicitação da Lista de Serviço no Município.
 *
 ...
 * @pw_complex sermListarResponse
 */
class SermListarResponse{
	/**
