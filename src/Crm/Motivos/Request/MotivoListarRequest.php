...
namespace OmieLib\Crm\Motivos\Request;

use OmieLib\Common\OmieFail;
use OmieLib\Crm\Motivos\Cadastros;
use OmieLib\Crm\Motivos\MotivosJsonClient;
use OmieLib\Crm\Motivos\Response\MotivoListarResponse;

/**
 * Solicitação da listagem de motivos da oportunidade.
 *
 ...
 * @pw_complex motivoListarRequest
 */
class MotivoListarRequest{
	/**
