...
namespace OmieLib\Crm\Tipos\Response;

use OmieLib\Common\OmieFail;
use OmieLib\Crm\Tipos\Cadastros;
use OmieLib\Crm\Tipos\Request\TipoListarRequest;
use OmieLib\Crm\Tipos\TiposJsonClient;

/**
 * Resposta da solicitação da listagem de tipos da oportunidade.
 *
 ...
 * @pw_complex tipoListarResponse
 */
class TipoListarResponse{
	/**
