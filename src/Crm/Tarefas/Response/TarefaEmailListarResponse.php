...
/**
 * Resposta da solicitação da listagem de emails "tarefas" da oportunidade.
 *
 * @pw_element integer $pagina Número da página retornada
 * @pw_element integer $total_de_paginas Número total de páginas
 * @pw_element integer $registros Número de registros retornados na página.
 * @pw_element integer $total_de_registros total de registros encontrados
 * @pw_element cadastrosEmailArray $cadastrosEmail Lista os cadastros de emails encontrados.
 * @pw_complex tarefaEmailListarResponse
 */
class TarefaEmailListarResponse{
	/**
