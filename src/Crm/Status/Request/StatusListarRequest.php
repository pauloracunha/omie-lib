...
namespace OmieLib\Crm\Status\Request;

use OmieLib\Common\OmieFail;
use OmieLib\Crm\Status\Cadastros;
use OmieLib\Crm\Status\Response\StatusListarResponse;
use OmieLib\Crm\Status\StatusJsonClient;

/**
 * Solicitação da listagem de status da oportunidade.
 *
 ...
 * @pw_complex statusListarRequest
 */
class StatusListarRequest{
	/**
