...
namespace OmieLib\Crm\Origens\Response;
...
/**
 * Resposta da solicitação da listagem de origens da oportunidade.
 *
 ...
 * @pw_complex origemListarResponse
 */
class OrigemListarResponse{
	/**
