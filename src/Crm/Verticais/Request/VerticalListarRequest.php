...
namespace OmieLib\Crm\Verticais\Request;

use OmieLib\Common\OmieFail;
use OmieLib\Crm\Verticais\Cadastros;
use OmieLib\Crm\Verticais\Response\VerticalListarResponse;
use OmieLib\Crm\Verticais\VerticaisJsonClient;

/**
 * Solicitação da listagem de verticais da conta/oportunidade.
 *
 ...
 * @pw_complex verticalListarRequest
 */
class VerticalListarRequest{
	/**
